...
- **ВАЖНО для JSON:** Если в тексте есть регулярные выражения (например, \\d, \\w), экранируй их правильно: \\\\d, \\\\w (4 обратных слеша в JSON для одного обратного слеша в строке)
"""
